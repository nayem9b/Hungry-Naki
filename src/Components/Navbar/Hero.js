...
import curry from "../andy-hay-ZN-TT10kf4o-unsplash.jpg";
      ...
      <section className='text-gray-600 body-font'>
        <div className='container mx-auto flex px-5 py-24 md:flex-row flex-col items-center'>
          <div className='lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0'>
            <img
              className='object-cover object-center rounded lg:h-[600px]'
              alt='hero'
              src={curry}
            />
          </div>
          <div className='lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center'>
            ...
            <p className='mb-8 leading-relaxed'>Feel free to subscribe</p>
            <div className='flex w-full md:justify-start justify-center items-end'>
              ...
              <button className='inline-flex text-white bg-orange-400 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded text-lg'>
                Subscribe
              </button>
            </div>

            <div className='flex lg:flex-row md:flex-col mt-6'>
